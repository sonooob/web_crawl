...
def get_item_info(url):
    ...
    date = soup.select('i.pr-5')[0].text.strip().split(u'\xa0')[0]
    cate = soup.select('#wrapper > div.content.clearfix > div.leftBox > div:nth-of-type(3) > div > ul > li:nth-of-type(1) > span > a')[0].text
